  ...
  return (
    <section className="relative isolate overflow-hidden px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
      <div
        ...
        aria-hidden="true"
      >
        <div className="drift-blob absolute left-[8%] top-[-10%] h-[320px] w-[320px] rounded-full bg-primary/15 blur-[120px] animate-[drift-1_18s_ease-in-out_infinite]" />
        <div className="drift-blob absolute bottom-[-14%] right-[6%] h-[360px] w-[360px] rounded-full bg-primary/10 blur-[140px] animate-[drift-2_24s_ease-in-out_infinite]" />
        <div className="drift-blob absolute right-[20%] top-[8%] h-[280px] w-[280px] rounded-full bg-foreground/[0.05] blur-[110px] animate-[drift-3_28s_ease-in-out_infinite]" />
      </div>
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-14">
        <div className="max-w-2xl text-center lg:text-left">
          ...
          <div className="hero-line hero-d3 mt-8 flex flex-col items-center gap-3 sm:flex-row lg:items-start">
            <Button className="group relative overflow-hidden rounded-full bg-primary px-6 py-5 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-all duration-300 hover:-translate-y-0.5 hover:bg-primary/90 hover:shadow-xl hover:shadow-primary/30 active:scale-[0.98]">
