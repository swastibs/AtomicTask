...
import { CheckCircle, UserPlus, Target, TrendingUp } from "lucide-react";
      ...
      >
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <h2 className="mb-4 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            Start with one habit and let it{" "}
            <span className="text-primary">snowball</span>
          </h2>
          <p className="text-lg text-muted-foreground">
            The experience is simple, but designed to make progress feel
            effortless.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {steps.map((step) => {
            ...
            return (
              ...
              >
                <div className="mb-4 text-4xl font-black text-primary/15">
                  {step.step}
                </div>
                <div className="mb-4 inline-flex size-12 items-center justify-center rounded-2xl bg-primary/10 text-primary transition-colors duration-300 group-hover:bg-primary/20">
