  ...
  const tiers = [
    {
      ...
      period: "forever",
      description:
        "Everything you need to start your first streak with clarity.",
      features: [
        "Unlimited tasks",
        "5 habits max",
        "Basic badges",
    ...
    },
    {
      ...
      period: "per month",
      description:
        "For teams that want momentum, alignment, and healthy rituals.",
      features: [
        "Everything in Pro",
        "Team dashboard",
        ...
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-3">
          {tiers.map((tier) => {
            ...
            return (
              <Card
                key={tier.name}
                className={`group hover-lift hover-glow relative border-border/70 bg-card/80 transition-all duration-300 ${tier.popular ? "ring-2 ring-primary shadow-xl" : ""}`}
              >
                {tier.popular && (
                ...
                <CardHeader>
                  <div className="mb-3 inline-flex size-11 items-center justify-center rounded-2xl bg-primary/10 text-primary transition-all duration-300 group-hover:bg-primary/20">
                ...
                <CardContent className="space-y-6">
                  ...
                  <Button
                    ...
                    className={`w-full rounded-full transition-all duration-300 ${tier.popular ? "bg-primary text-primary-foreground hover:bg-primary/90" : "border-border text-foreground hover:bg-muted"}`}
                  >
                    {tier.buttonText}
                  </Button>
                </CardContent>
