...
export function Features() {
  return (
    <SectionReveal id="features" className="relative isolate overflow-hidden px-4 py-20 sm:px-6 lg:px-8 lg:py-32">
      <div className="mx-auto mb-14 max-w-3xl text-center">
        <p className="mb-4 text-[10px] font-bold uppercase tracking-[0.24em] text-primary">
          Features
        </p>
        <h2 className="mb-4 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
          Beautiful systems for <span className="text-primary">bold routines</span>
        </h2>
        <p className="text-lg text-muted-foreground">
          AtomicTask combines planning, reflection, and momentum into one polished experience.
        </p>
      </div>
