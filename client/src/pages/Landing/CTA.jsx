        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-primary/20 bg-gradient-to-br from-primary via-orange-500 to-amber-500 p-10 text-primary-foreground shadow-[0_24px_80px_-24px_rgba(231,111,81,0.5)] sm:p-14 lg:p-16">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Button className="rounded-full bg-white px-6 py-5 text-sm font-semibold text-primary shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/90 active:scale-[0.98]">
                Get started free
                <Rocket className="ml-2 size-4" />
              </Button>
              <Button
                variant="outline"
                className="rounded-full border-white/30 bg-white/10 px-6 py-5 text-sm font-semibold text-white transition-all duration-300 hover:bg-white/20"
              >
                View the demo
