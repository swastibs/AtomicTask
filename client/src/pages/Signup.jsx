...
export function Signup() {
  ...
  return (
    <div className="relative isolate min-h-[80vh] overflow-hidden px-4 py-12">
      ...
      <div className="pointer-events-none absolute left-8 top-12 h-14 w-14 rounded-full bg-primary/20 blur-2xl animate-[drift-2_28s_ease-in-out_infinite]" />
      <div className="pointer-events-none absolute right-10 top-24 h-16 w-16 rounded-2xl bg-primary/10 opacity-80 blur-2xl animate-[drift-1_30s_ease-in-out_infinite]" />
      <div className="pointer-events-none absolute left-1/3 bottom-16 h-0 w-0 text-foreground/5 opacity-85 shape-triangle animate-[drift-3_26s_ease-in-out_infinite]" />
      <div className="pointer-events-none absolute right-16 bottom-14 h-12 w-12 rounded-full border border-primary/20 bg-foreground/5 blur-xl animate-[drift-2_32s_ease-in-out_infinite]" />
          ...
          <div className="relative z-10 px-6 py-10 sm:px-10 sm:py-12">
            <CardHeader className="space-y-2 text-center">
              ...
              <p className="max-w-xl mx-auto text-sm leading-7 text-muted-foreground">
                Build momentum with a premium experience designed for focused clarity.
              </p>
            </CardHeader>
